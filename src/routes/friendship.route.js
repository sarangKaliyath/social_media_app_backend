...
const { sendFriendsRequest, acceptFriendsRequest, getPendingRequestList, getFriendsList, removeFriend, rejectRequest } = require("../controllers/friendship.controller");
